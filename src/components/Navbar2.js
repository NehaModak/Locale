        ...
        return (
            <ul className="navbar-nav ml-auto">
                <li className="nav-item">
                    <span className="nav-link active text-uppercase mr-2"><Link to="/restaurants">Shops</Link></span>
                </li>
                <li className="nav-item">
                ...
                <li className="nav-item">
                    <Link to="/register-restaurant">
                        <button type="button" className="btn btn-warning btn-sm text-uppercase mr-2 mr-1 px-3">Register Shops</button>
                    </Link>
                </li>
            </ul>
        )
