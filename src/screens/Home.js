    ...
    return (
      <div>
        ...
        <div className="container-fluid home-cont1">
          <div className="">
            ...
            <div className="container home-cont1-text">
              <h1 className="h1 text-uppercase text-white text-center mb-4"><strong>Local market at your doorstep <br />Just One click Away</strong></h1>
        ...
        <div className="container-fluid py-2 bg-warning">
          <div className="row">
            <div className="col-lg-4 col-md-4 col-sm-12">
              <p className="my-3 text-lg-right text-md-right text-center text-white"><b className="mr-2 h5">18</b>Nearby Shops</p>
            </div>
            <div className="col-lg-4 col-md-4 col-sm-12">
          ...
          <div className="container">
            <div className="row">
              <div className="col-12 col-lg-4 col-md-4 px-5">
                ...
                <h3 className="h3 mb-4">Choose A nearby shop</h3>
                <p className="mb-4">Just Click on the Shop you want to shop from, will make them available to you.</p>
              </div>
              <div className="col-12 col-lg-4 col-md-4 px-5">
                <span className="round-border my-4">
                ...
                <p className="mb-4">Simply click and select the dress you want.</p>
              </div>
              <div className="col-12 col-lg-4 col-md-4 px-5">
                <span className="round-border my-4">
                  <img alt="Pick up or Delivery or Pick up at" src={require("../assets/images/how-to-work1.png")} />
                </span>
                <h3 className="h3 mb-4">Visit the shop or Delivery</h3>
        ...
        <div className="container-fluid text-center py-5 home-cont3">
          <p className="h1 text-uppercase text-white mt-5 mb-3">Just Tell Us The Location We Will Reach You/You can visit the shop</p>
        ...
        <div className="container-fluid py-5">
          <div className="py-4">
            <h2 className="h2 text-uppercase text-center">Featured Nearby shops</h2>
            <p className="text-center">The list of the registered nearby shops of clothing and accessories.</p>
          </div>
          <div className="container">
            <div className="row">
                ...
                <div className="container res-shadow res-border">
                  <div className="row p-3">
                    ...
                    <div style={{ position: "relative" }} className="col-lg-8 col-md-8 col-sm-12 py-2">
                      <h5 className="mb-1">Handmade</h5>
                      <p className="mb-2"><small>Western wear, Indian Ethnic wear, Party wear</small></p>
                      <p>
                        <small className="">
              ...
              <div className="col-lg-6 col-md-6 col-sm-12 mb-4">
                <div className="container res-shadow res-border">
                  <div className="row p-3">
                    ...
                    <div style={{ position: "relative" }} className="col-lg-8 col-md-8 col-sm-12 py-2">
                      <h5 className="mb-1">Style Shop</h5>
                      <p className="mb-2"><small>Salwar, Kurta, Jeans, Tops, Saree</small></p>
                      <p>
                        <small className="">
                          <FontAwesomeIcon icon="star" className="rating mr-1" />
                          <FontAwesomeIcon icon="star" className="rating mr-1" />
              ...
              <div className="col-lg-6 col-md-6 col-sm-12 mb-4">
                <div className="container res-shadow res-border">
                  <div className="row p-3">
                    ...
                    <div style={{ position: "relative" }} className="col-lg-8 col-md-8 col-sm-12 py-2">
                      <h5 className="mb-1">Vogue Store</h5>
                      <p className="mb-2"><small>Lehenga, Frock, Kurti</small></p>
                      <p>
                        <small className="">
                          <FontAwesomeIcon icon="star" className="rating mr-1" />
                          <FontAwesomeIcon icon="star" className="rating mr-1" />
              ...
              <div className="col-lg-6 col-md-6 col-sm-12 mb-4">
                <div className="container res-shadow res-border">
                  <div className="row p-3">
                    ...
                    <div style={{ position: "relative" }} className="col-lg-8 col-md-8 col-sm-12 py-2">
                      <h5 className="mb-1">Metro Bazaar</h5>
                      <p className="mb-2"><small>Kids wear, Women's wear, Men's wear</small></p>
                      <p>
                        <small className="">
                          <FontAwesomeIcon icon="star" className="rating mr-1" />
                          <FontAwesomeIcon icon="star" className="rating mr-1" />
              ...
              <div className="col-lg-6 col-md-6 col-sm-12 mb-4">
                <div className="container res-shadow res-border">
                  <div className="row p-3">
                    ...
                    <div style={{ position: "relative" }} className="col-lg-8 col-md-8 col-sm-12 py-2">
                      <h5 className="mb-1">Fashion Fit</h5>
                      <p className="mb-2"><small>Sale, flat 50% off on selected items</small></p>
                      <p>
                        <small className="">
                          <FontAwesomeIcon icon="star" className="rating mr-1" />
                          <FontAwesomeIcon icon="star" className="rating mr-1" />
              ...
              <div className="col-lg-6 col-md-6 col-sm-12 mb-4">
                <div className="container res-shadow res-border">
                  <div className="row p-3">
                    ...
                    <div style={{ position: "relative" }} className="col-lg-8 col-md-8 col-sm-12 py-2">
                      <h5 className="mb-1">Gupta Stores</h5>
                      <p className="mb-2"><small>Shirts, T-Shirts, Jeans, Pants</small></p>
                      <p>
                        <small className="">
                          <FontAwesomeIcon icon="star" className="rating mr-1" />
                          <FontAwesomeIcon icon="star" className="rating mr-1" />
