                    ...
                    <div className="container bg-white p-3 px-0 mb-4" key={restaurantList[val].id}>
                        <div className="row">
                            ...
                            <div className="col-lg-6 col-md-6 col-sm-12 px-0">
                                ...
                                <p className=""><small>Type of Clothing: <span>{restaurantList[val].typeOfFood.join(', ')}</span></small></p>
                            </div>
                    ...
                    <div className="container bg-white p-3 px-0 mb-4" key={searchRestaurants[val].id}>
                        <div className="row">
                            ...
                            <div className="col-lg-6 col-md-6 col-sm-12 px-0">
                                ...
                                <p className=""><small>Type of Clothing: <span>{searchRestaurants[val].typeOfFood.join(', ')}</span></small></p>
                            </div>
                            <div className="col-lg-3 col-md-3 col-sm-12 py-4 px-0">
                                <span style={{ display: 'inline-block', textAlign: 'center', borderRadius: '3px', border: '1px solid #dddddd', padding: '6px 7px 0px 7px', marginRight: '16px' }} ><FontAwesomeIcon icon="heart" className="text-success" /></span>
                                <button type="button" onClick={() => this.handleViewMenuBtn(searchRestaurants[val])} className="btn btn-warning btn-sm text-uppercase" style={{ marginBottom: '8px' }}>View Catalogue</button>
                            </div>
                        </div>
                    </div>
                )
                    ...
                    <div className="container">
                        <div className="row">
                                        ...
                                        <ul className="filter-list">
                                            ...
                                            <li>
                                                <div className="custom-control custom-checkbox">
                                                    ...
                                                    <label className="custom-control-label" htmlFor="chicken-roast">Party Wear</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="custom-control custom-checkbox">
                                                    ...
                                                    <label className="custom-control-label" htmlFor="cheese-burger">Accessories</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="custom-control custom-checkbox">
                                                    ...
                                                    <label className="custom-control-label" htmlFor="cold-coffee">Casual Wear</label>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div className="col-lg-7 col-md-7 col-sm-12">
                                <h4 className="mb-3">Nearby Shop found</h4>
