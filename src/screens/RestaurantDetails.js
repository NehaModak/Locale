                            ...
                            <div className="col-lg-2 col-md-2 col-sm-12">
                                <div className="listing-category">
                                    <div className="category-heading py-0 mb-1">
                                        <h6 className="m-0"><FontAwesomeIcon icon="fas fa-tshirt" className="mr-2" />Categories</h6>
                                    </div>
                                    <div>
                                ...
                                <div className="container">
                                    <div className="row">
                                        <div className={tab1} onClick={() => this.handleTabs("tab1")}>
                                            <p className="res-details-tab-text"><FontAwesomeIcon icon="concierge-bell" className="mr-3" />Collection</p>
                                        </div>
                                        ...
                                        <div className={tab3} onClick={() => this.handleTabs("tab3")}>
                                            <p className="res-details-tab-text"><FontAwesomeIcon icon="info-circle" className="mr-3" />Shop Info</p>
                                        </div>
                                    </div>
                                    {tab1Content &&
                                        < div className="row menu-section">
                                            <div className="col-12 bg-white p-4">
                                                ...
                                                <div>
                                                    <h6 className="mb-4 text-warning">Best Clothing items:</h6>
                                    ...
                                    {tab3Content && <div className="row info-section">
                                        <div className="col-12 bg-white p-4">
                                            ...
                                            <p>Look, for what suits you best at the comfort of home. 
                                                Verify the product you wish to buy from the shopkepper directly.
                                                Visit the shop and try out the dress by yourself.
                                                You can also get your favourites delivered ASAP.</p>
                                        </div>
                                    </div>
                                    }
                                </div>
