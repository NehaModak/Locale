                ...
                <div className="container-fluid register-cont1">
                    <div className="">
                        ...
                        <div className="container register-cont1-text">
                            <h1 className="text-uppercase text-white text-center mb-4"><strong>Add Your Best Clothing item</strong></h1>
                        </div>
                    </div>
                </div>
                <div className="container-fluid py-5 bg-light">
                    <div className="col-lg-6 col-md-6 col-sm-12 mx-auto bg-white shadow p-4">
                        <h2 className="text-center mb-4">Add Clothing Items</h2>
                        <form action="javascript:void(0)">
                            <div className="form-row">
                                ...
                                <div className="form-group col-md-6">
                                    <label htmlFor="itemIngredients"><b>Item Accessories</b></label>
                            ...
                            <div className="form-row">
                                <div className="form-group col-md-3">
                                    <div className="custom-control custom-radio">
                                        ...
                                        <label className="custom-control-label" htmlFor="kebabs">Top Wear</label>
                                    </div>
                                </div>
                                <div className="form-group col-md-3">
                                    <div className="custom-control custom-radio">
                                        ...
                                        <label className="custom-control-label" htmlFor="chicken">Bottom Wear</label>
                                    </div>
                                </div>
                                <div className="form-group col-md-3">
                                    <div className="custom-control custom-radio">
                                        ...
                                        <label className="custom-control-label" htmlFor="burgers">Men's Fashion</label>
                                    </div>
                                </div>
                                <div className="form-group col-md-3">
                                    <div className="custom-control custom-radio">
                                        ...
                                        <label className="custom-control-label" htmlFor="biryani">Women's Fashion</label>
                                    </div>
                                </div>
                            </div>
                            <div className="form-row">
                                <div className="form-group col-md-3">
                                    <div className="custom-control custom-radio">
                                        ...
                                        <label className="custom-control-label" htmlFor="sauces">For Kids</label>
                                    </div>
                                </div>
                                <div className="form-group col-md-3">
                                    <div className="custom-control custom-radio">
                                        ...
                                        <label className="custom-control-label" htmlFor="vegetarian">Indian Ethnic Wear</label>
                                    </div>
                                </div>
                                <div className="form-group col-md-3">
                                    <div className="custom-control custom-radio">
                                        ...
                                        <label className="custom-control-label" htmlFor="bread">Western Wear</label>
                                    </div>
                                </div>
                                <div className="form-group col-md-3">
                                    <div className="custom-control custom-radio">
